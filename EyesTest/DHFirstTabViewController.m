...
#import "DHFirstTabViewController.h"
#import "DHScaleTableViewController.h"
@interface DHFirstTabViewController ()

@end

@implementation DHFirstTabViewController{
    NSArray*steps;
}
...
- (void)viewDidLoad
{
    ...
    steps= [tabDic  objectForKey:@"FirstTabInfo"];
...
//    DHScaleTableViewController*objDHScaleTableViewController=[[DHScaleTableViewController alloc]initWithNibName:nil bundle:nil];
//    [self.navigationController pushViewController:objDHScaleTableViewController animated:YES];
//}
@end
